...
wf3d_error wf3d_Object3d_Rasterization(wf3d_Object3d const* obj, wf3d_img_gen_interface* img_out, float* depth_buffer, wf3d_vect3d cam_pos, wf3d_quat cam_rot, float tan_h_half_opening_angle, float tan_v_half_opening_angle, float render_distance, bool blackface_culling_enabled)
{
    ...
    wf3d_quat const cam_rot_conj = wf3d_quat_conj(cam_rot);
    ...
    wf3d_quat v_inv = wf3d_quat_transform_vect3d(
                                                        cam_rot_conj,
                                                        wf3d_vect3d_sub(obj->v_pos, cam_pos)
                                                    );

    float half_width = 0.5f * (float)img_out->width;
    float half_height = 0.5f * (float)img_out->height;

    float x_scale = half_width / tan_h_half_opening_angle;
    float y_scale = half_height / tan_v_half_opening_angle;
